...
function Layout() {
  ...
  const navItems = [
    { path: '/', label: 'Home' },
    { path: '/blog-posts', label: 'Blog Posts' },
    { path: '/programming-stuff', label: 'Programming Stuff' },
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <Link to="/" className="flex items-center space-x-2">
              ...
              <span className="text-xl md:text-2xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent leading-none">
                AI Insights
              </span>
            </Link>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-gray-400">
                Exploring the frontier of AI, programming, and intelligent automation.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-gray-400">
                Built with React, Tailwind CSS, and powered by AI insights.
              </p>
            </div>
          </div>
